...
public class PaxStatementSlotImpl extends ASTWrapperPsiElement implements PaxStatementSlot {

  public PaxStatementSlotImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitStatementSlot(this);
  }

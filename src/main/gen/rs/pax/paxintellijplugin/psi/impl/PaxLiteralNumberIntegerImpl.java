...
public class PaxLiteralNumberIntegerImpl extends ASTWrapperPsiElement implements PaxLiteralNumberInteger {

  public PaxLiteralNumberIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitLiteralNumberInteger(this);
  }

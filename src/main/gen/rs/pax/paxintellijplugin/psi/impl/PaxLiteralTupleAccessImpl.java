...
public class PaxLiteralTupleAccessImpl extends ASTWrapperPsiElement implements PaxLiteralTupleAccess {

  public PaxLiteralTupleAccessImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitLiteralTupleAccess(this);
  }

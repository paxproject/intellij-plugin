...
public class PaxXoFunctionArgsListImpl extends ASTWrapperPsiElement implements PaxXoFunctionArgsList {

  public PaxXoFunctionArgsListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitXoFunctionArgsList(this);
  }

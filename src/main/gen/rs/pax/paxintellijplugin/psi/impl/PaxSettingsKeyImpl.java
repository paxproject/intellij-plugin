...
public class PaxSettingsKeyImpl extends ASTWrapperPsiElement implements PaxSettingsKey {

  public PaxSettingsKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitSettingsKey(this);
  }

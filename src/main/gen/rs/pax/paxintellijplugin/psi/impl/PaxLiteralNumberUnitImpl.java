...
public class PaxLiteralNumberUnitImpl extends ASTWrapperPsiElement implements PaxLiteralNumberUnit {

  public PaxLiteralNumberUnitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitLiteralNumberUnit(this);
  }

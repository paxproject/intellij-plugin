...
public class PaxNodeInnerContentImpl extends ASTWrapperPsiElement implements PaxNodeInnerContent {

  public PaxNodeInnerContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitNodeInnerContent(this);
  }

...
public class PaxSettingsKeyValuePairImpl extends ASTWrapperPsiElement implements PaxSettingsKeyValuePair {

  public PaxSettingsKeyValuePairImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitSettingsKeyValuePair(this);
  }
  ...
  @Override
  @NotNull
  public PaxSettingsValue getSettingsValue() {
    return findNotNullChildByClass(PaxSettingsValue.class);
  }

...
public class PaxEventsKeyImpl extends ASTWrapperPsiElement implements PaxEventsKey {

  public PaxEventsKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitEventsKey(this);
  }

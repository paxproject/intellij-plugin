...
public class PaxExpressionWrappedImpl extends ASTWrapperPsiElement implements PaxExpressionWrapped {

  public PaxExpressionWrappedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitExpressionWrapped(this);
  }

...
public class PaxLiteralEnumArgsListImpl extends ASTWrapperPsiElement implements PaxLiteralEnumArgsList {

  public PaxLiteralEnumArgsListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PaxVisitor visitor) {
    visitor.visitLiteralEnumArgsList(this);
  }
